...
🔗 [← Previous brief](../../2026-06-14/reports/daily.md)
...
`📥 read` · `🟡 medium` · `📍 primary_artifact` · `🆕 new` · `🏷️ topic_agent-dashboard`

✨ [FACT] Jun 15, 2026 Agent Dashboard in Grok Build Jun 15, 2026 Agent Dashboard in Grok Build Manage many coding sessions at once. See what each is doing, reply to the ones that need you, and dispatch new work. Read More

🔗 [xAI News](https://x.ai/news/agent-dashboard)

<sub>`cluster_9a2747671e699632`</sub>
...
16. 📥 read · [Introducing the OpenAI Partner Network](https://openai.com/index/introducing-openai-partner-network) — OpenAI launches the Partner Network, investing $150M to help global partners accelerate enterprise AI adoption, deployment, and transformation. (`cluster_9461ae150071f6e7`)
...
20. 📥 read · [Benchmarking Web Agent Safety under E-commerce Deceptive Interfaces](https://arxiv.org/abs/2606.13686) — arXiv:2606.13686v1 Announce Type: new Abstract: As autonomous web agents are increasingly deployed to perform real-world tasks, ensuring their safety has become a critical concern. In this work, we study web agent behavior under realistic deceptive interfaces in the e-commerce domain. We introduce WebDecept, a lightweight and configurable plugin framework that enables controlled injection of deceptive interface patterns into existing web environments. Using WebDecept, we instantiate seven decep… (`cluster_cef7f405727d41b7`)
...
23. 📥 read · [Expanding Project Glasswing](https://www.anthropic.com/news/expanding-project-glasswing) — Announcements Jun 2, 2026 Expanding Project Glasswing We’re extending Project Glasswing to approximately 150 new organizations in more than fifteen countries. (`cluster_0bebee2763bb4b83`)
...
25. 📥 read · [Claude Fable 5 and new AI safety fables](https://www.interconnects.ai/p/claude-fable-5-and-new-ai-safety) — One step further into the power politics of frontier AI systems. (`cluster_7a8973e08eab211f`)
...
29. 📥 read · [Welcome to the AGI era of AI governance](https://www.interconnects.ai/p/welcome-to-the-agi-era-of-ai-governance) — It's a one-way door and we weren't ready for it. (`cluster_71da31dfd99ce6c8`)
...
31. 📥 read · [Grok Warp](https://x.ai/news/grok-warp) — Jun 15, 2026 Use Grok in Warp (`cluster_bf4951c7dcdfe7e8`)
...
40. 📥 read · [The Coin Flip Judge? Reliability and Bias in LLM-as-a-Judge Evaluation](https://arxiv.org/abs/2606.13685) — arXiv:2606.13685v1 Announce Type: new Abstract: LLM-as-a-Judge is now widely used to rank model outputs, train reward models, and populate public leaderboards, but its run-to-run reliability remains under-characterized. We study repeated identical evaluations on 29 tasks spanning 10 categories using two OpenAI judge models (GPT-4o-mini and GPT-4.1-mini), with 50 pairwise trials and 50 pointwise trials per question, supplemented by temperature and prompt-sensitivity ablations. Across judges, pai… (`cluster_40ee1b94c419e16b`)
41. 📥 read · ["They screwed us": Personality clashes sent Anthropic's models offline](https://simonwillison.net/2026/Jun/15/axios-clashes-anthropics) — &quot;They screwed us&quot;: Personality clashes sent Anthropic&#x27;s models offline Lots of "source familiar with the administration's thinking" and "source close to Anthropic" in this Axios piece, which is the best collection of behind-the-scenes gossip I've seen about the US government export control Mythos/Fable story so far. Logan Graham ( I lead the Frontier Red Team at Anthropic ), Dave Orr (Head of Safeguards, previously a Director of Engineering at Google DeepMind), and blog favorite… (`cluster_c5cb753a740124ba`)
42. 📥 read · [Quoting Julia Evans](https://simonwillison.net/2026/Jun/15/julia-evans) — [...] Instead, I picture a specific person and I just write for them. Often this person is "me, but 3 years ago" or a good friend. &mdash; Julia Evans , write for 1 person Tags: writing , julia-evans (`cluster_accea7a2c7f845d4`)
...
45. 📥 read · [Mistral Small 4](https://mistral.ai/news/mistral-small-4) (`cluster_a15d2e6def4b098e`)
46. 📥 read · [A low-carbon computing platform from your retired phones](https://research.google/blog/a-low-carbon-computing-platform-from-your-retired-phones) — Climate & Sustainability (`cluster_6d01bd78a38787ba`)
47. 📥 read · [Research into how AI can help users understand skin conditions](https://research.google/blog/research-into-how-ai-can-help-users-understand-skin-conditions) — Health & Bioscience (`cluster_b6ef90cb101a9214`)
48. 📥 read · [Boosting MoE Training Throughput with Advanced Fusion Kernels](https://developer.nvidia.com/blog/boosting-moe-training-throughput-with-advanced-fusion-kernels) —  (`cluster_ebd1afcef952bf4c`)
49. 📥 read · [Pretrained to Imagine, Fine-Tuned to Act: The Rise of World-Action Models](https://developer.nvidia.com/blog/pretrained-to-imagine-fine-tuned-to-act-the-rise-of-world-action-models) —  (`cluster_f1678399dd3ce41c`)
