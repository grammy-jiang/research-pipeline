...
# 🧠 Daily AI Intelligence Brief — 2026-06-19

🔗 [← Previous brief](../../2026-06-18/reports/daily.md)
...
- ✨ **[Improving health intelligence in ChatGPT](#2-improving-health-intelligence-in-chatgpt)** — 📥 read · Learn how GPT-5.5 Instant improves ChatGPT’s health and wellness responses with stronger reasoning, better context, clearer communication, and physician-informed evaluations.
...
`📥 read` · `🟢 high` · `📍 primary_artifact` · `🆕 new` · `🏷️ topic_improving-health-intelligence-chatgpt`

✨ [FACT] Learn how GPT-5.5 Instant improves ChatGPT’s health and wellness responses with stronger reasoning, better context, clearer communication, and physician-informed evaluations.

🔗 [OpenAI](https://openai.com/index/improving-health-intelligence-in-chatgpt)

<sub>`cluster_1c5a5bee65ccf8e4`</sub>
...
`📥 read` · `🟢 high` · `📍 primary_artifact` · `🆕 new` · `🏷️ topic_securing-the-future-agents`

✨ [FACT] Securing internal systems with an AI Control Roadmap, combining traditional safeguards and real-time monitoring.

🔗 [Google DeepMind Blog](https://deepmind.google/blog/securing-the-future-of-ai-agents)

<sub>`cluster_a70b5cc7b233e053`</sub>

### 8. Using AI to help physicians diagnose rare genetic diseases affecting children

`📥 read` · `🟢 high` · `📍 primary_artifact` · `🆕 new` · `🏷️ topic_using-help-physicians-diagnose-rare`

✨ [FACT] Researchers used an OpenAI reasoning model to help diagnose rare diseases, identifying 18 new diagnoses in previously unsolved cases.

🔗 [OpenAI](https://openai.com/index/diagnose-rare-childhood-diseases)

<sub>`cluster_5d8110b77643d42f`</sub>
...
### 14. New usage analytics and updated spend controls for enterprises

`📥 read` · `🟢 high` · `📍 primary_artifact` · `🆕 new` · `🏷️ topic_new-usage-analytics-and-updated`

✨ [FACT] OpenAI introduces new spend controls and usage analytics for ChatGPT Enterprise, helping organizations manage costs and scale AI with confidence.

🔗 [OpenAI](https://openai.com/index/chatgpt-enterprise-spend-controls)

<sub>`cluster_1d6cf00f4b698507`</sub>
...
19. 📥 read · [Datasette Apps: Host custom HTML applications inside Datasette](https://simonwillison.net/2026/Jun/18/datasette-apps) — Today we launched a new plugin for Datasette, datasette-apps , with this launch announcement post on the Datasette project blog. That post has the what , but I'm going to expand on that a little bit here to provide the why . The TL;DR Datasette Apps are self-contained HTML+JavaScript applications that run in a tightly constrained &lt;iframe&gt; sandbox hosted on your Datasette application. They can use JavaScript to run read-only SQL queries against data in Datasette, and can run write queries… (`cluster_d803ed885b0ad3ca`)
...
27. 📥 read · [Realtime Perplexity Computer](https://developers.openai.com/blog/realtime-perplexity-computer) — How Perplexity Brought Voice Search to Millions Using the Realtime API (`cluster_dd9b7901a813c718`)
28. 📥 read · [State of the blog, mid-2026](https://www.interconnects.ai/p/state-of-the-blog-mid-2026) — About 3 years since I started writing weekly. (`cluster_9e010b97b8d18816`)
...
30. 📥 read · [Grok Databricks](https://x.ai/news/grok-databricks) — Jun 18, 2026 Grok on Databricks (`cluster_09bca3494800fb36`)
31. 📥 read · [Introducing Word Addin](https://x.ai/news/introducing-word-addin) — Jun 18, 2026 Grok for Word Jun 18, 2026 Grok for Word Use the Grok add-in for Microsoft Word to turn notes into documents, style and format your work, or bring research from the web into Word. Read More (`cluster_ab39693cd6edb170`)
32. 📥 read · [Ire identifies another LOTUSLITE specimen](https://www.microsoft.com/en-us/research/blog/ire-identifies-another-lotuslite-specimen) — Project Ire examined a timely malware sample and determined its intent through reverse engineering—identifying LOTUSLITE characteristics even as most major EDR tools did not detect it. The post Ire identifies another LOTUSLITE specimen appeared first on Microsoft Research . (`cluster_1af093c21ec9a3a1`)
33. 📥 read · [Introducing Web Search on Amazon Bedrock AgentCore](https://aws.amazon.com/blogs/machine-learning/introducing-web-search-on-amazon-bedrock-agentcore) — Web Search on Amazon Bedrock AgentCore is now generally available. In this post, we walk through what makes Web Search on Amazon Bedrock AgentCore different, why it matters, and how to wire it in with a few lines of code. (`cluster_7db98217d14b7380`)
34. 📥 read · [[AINews] GLM > GPT? GLM-5.2 passes vibe check; Z.ai forecasts Open Fable by December](https://www.latent.space/p/ainews-glm-gpt-glm-52-passes-vibe) — With GLM-5.2 passing everyone's vibe check, the open models story finally becomes a real frontier story. (`cluster_da4e79bb259c112a`)
...
45. 📥 read · [Building AI Agents for AR Glasses and XR Devices with NVIDIA XR AI](https://developer.nvidia.com/blog/building-ai-agents-for-ar-glasses-and-xr-devices-with-nvidia-xr-ai) —  (`cluster_8333954081b6c131`)
...
| Improving health intelligence in ChatGPT | `research-pipeline brief feedback --cluster cluster_1c5a5bee65ccf8e4 --signal keep` |
