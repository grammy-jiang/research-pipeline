...
_STRUCTURED_SYNTHESIS_TEMPLATE = r"""
...
| Synthesis snapshot | Papers analyzed |
|--------------------|-----------------|
| {{ timestamp }} | {{ report.corpus|length }} |

Only the current synthesis snapshot is recorded here; no prior-round history was
