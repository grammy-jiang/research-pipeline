# Feature Acceptance Contract: Add report/event validator
...
Validate events and reports deterministically.
...
- `src/research_pipeline/briefing/validate.py`
- `tests/unit/test_briefing_validate.py`
...
```bash
uv run pytest tests/unit/test_briefing_validate.py -xvs
...
```text
docs/daily-ai-intelligence/proofs/A09_report_and_event_validator.md
```
