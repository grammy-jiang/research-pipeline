# Feature Acceptance Contract: Add source-expansion governance and side-by-side evaluation

## Feature ID
`F01_source_expansion_governance`

## Goal
Add source-expansion governance and side-by-side evaluation for Phase F source expansion.
...
- `src/research_pipeline/briefing/source_evaluation.py`
- `tests/unit/test_briefing_source_evaluation.py`
