# Feature Acceptance Contract: Add namespaced brief_* MCP tools

## Feature ID
`G04_mcp_tools`

## Goal
Add namespaced brief_* MCP tools for Phase G harness hardening and agent workflows.
...
- `src/research_pipeline/mcp_server/tools.py`
- `tests/unit/test_mcp_briefing_tools.py`
