# Feature Acceptance Contract: Require primary artifact before dossier generation

## Feature ID
`E04_primary_artifact_gate`

## Goal
Require primary artifact before dossier generation for Phase E hot-topic dossiers.
...
- `tests/unit/test_briefing_dossier_primary_artifact.py`
