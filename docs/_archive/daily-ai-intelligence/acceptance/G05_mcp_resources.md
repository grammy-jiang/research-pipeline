# Feature Acceptance Contract: Add MCP resources for briefing artifacts

## Feature ID
`G05_mcp_resources`

## Goal
Add MCP resources for briefing artifacts for Phase G harness hardening and agent workflows.
...
- `src/research_pipeline/mcp_server/resources.py`
- `tests/unit/test_mcp_briefing_resources.py`
