# Feature Acceptance Contract: Add stage verifier registry

## Feature ID
`G02_stage_verifiers`

## Goal
Add stage verifier registry for Phase G harness hardening and agent workflows.
...
- `src/research_pipeline/briefing/workflow_verification.py`
- `tests/unit/test_briefing_workflow_verification.py`
