# Feature Acceptance Contract: Add manual CLI command brief dossier --cluster

## Feature ID
`E03_dossier_cli_manual`

## Goal
Add manual CLI command brief dossier --cluster for Phase E hot-topic dossiers.
...
- `tests/unit/test_briefing_cli_dossier.py`
